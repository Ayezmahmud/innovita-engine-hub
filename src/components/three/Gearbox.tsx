...
function HexBolt({ m, size = 0.045, ...props }: { m: M; size?: number | undefined } & React.ComponentProps<"group">) {
  return (
    <group {...props}>
...
function BoltCircle({ m, count, radius, size }: { m: M; count: number; radius: number; size?: number | undefined }) {
  return (
    <>
